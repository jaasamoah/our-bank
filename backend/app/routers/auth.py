...
def _send_login_otp(user: User, otp: str) -> None:
    ...
    payload = {
        "from": sender,
        "to": [user.email],
        "subject": "Your Velmont Bank verification code",
        "text": f"Your Velmont Bank verification code is {otp}. It expires in {OTP_EXPIRE_MINUTES} minutes. If you did not try to sign in, contact support.",
        "html": (
            "<div style=\"font-family:Arial,sans-serif;line-height:1.5\">"
            "<h2>Velmont Bank verification code</h2>"
