          ...
          {step === 'complete' ? (
            <div className="text-center">
              ...
              <button
                ...
                className="mt-6 w-full rounded-xl bg-brand-700 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-brand-800"
              >
                Return to sign in
              </button>
            </div>
            ...
            <>
              ...
              {step === 'request' ? (
                <form onSubmit={submitRequest} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex w-full items-center justify-center rounded-xl bg-brand-700 px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-brand-800 disabled:opacity-60"
                  >
              ...
              <Link
                to="/login"
                className="mt-6 flex items-center justify-center gap-2 text-sm font-medium text-slate-500 transition hover:text-brand-700"
              >
